...
const destinations = [
  // ── Domestic Packages (12) ──────────────────────────────────────────────────
  {
    ...
    tag: 'Top Rated',
    category: 'Domestic',
    image: 'https://images.unsplash.com/photo-1663407978077-ca116e36abf0?q=80&w=987&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
  ...
  },
  {
    ...
    tag: 'Best Seller',
    category: 'Domestic',
    image: 'https://i.pinimg.com/736x/75/6a/92/756a928de1764a85671b78828fdae92e.jpg',
  ...
  },
  {
    ...
    tag: 'Popular',
    category: 'Domestic',
    image: 'https://images.unsplash.com/photo-1609920658906-8223bd289001?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8bWFuYWxpfGVufDB8fDB8fHww',
    highlights: ['Mall Road', 'Rohtang Pass', 'Solang Valley', 'Hadimba Temple'],
    description: 'From Shimla\'s colonial charm to Manali\'s adventure valleys — the ultimate Himalayan twin-city escape.',
  },
  {
    id: 4,
    ...
    tag: 'Popular',
    category: 'Domestic',
    image: 'https://images.unsplash.com/photo-1698753864905-a447aa362ec9?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8ZGFyamVlbGluZ3xlbnwwfHwwfHx8MA%3D%3D',
    highlights: ['Tiger Hill', 'Tsomgo Lake', 'Nathula Pass', 'Tea Estates'],
    description: 'Sunrise over Kanchenjunga, aromatic tea plantations and vibrant Sikkimese culture in one stunning journey.',
  },
  {
    id: 5,
    ...
    tag: 'Trending',
    category: 'Domestic',
    image: 'https://chatterjeetourism.com/wp-content/uploads/2024/02/SHILLONG.jpg',
    highlights: ['Kamakhya Temple', 'Shillong Peak', 'Elephant Falls', 'Dawki River'],
    description: 'Misty hills, living root bridges and crystal-clear rivers — the unexplored gem of Northeast India.',
  },
  {
    id: 6,
    ...
    tag: 'Popular',
    category: 'Domestic',
    image: 'https://res.klook.com/image/upload/w_750,h_469,c_fill,q_85/w_80,x_15,y_15,g_south_west,l_Klook_water_br_trans_yhcmh3/activities/je7f7afinucn8z4ichia.jpg',
    highlights: ['Naini Lake', 'Jim Corbett Safari', 'Naina Devi Temple', 'Snow View Point'],
    description: 'Boat rides on emerald lakes and thrilling tiger safaris in India\'s oldest national park.',
  },
  {
    id: 7,
    name: 'Kerala',
    ...
    highlights: ['Alleppey Backwaters', 'Munnar Tea Gardens', 'Kochi Fort', 'Periyar Wildlife'],
  ...
  },
  {
    ...
    tag: 'Trending',
    category: 'Domestic',
    image: 'https://images.unsplash.com/photo-1657894736581-ccc35d62d9e2?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8aGltYWNoYWwlMjBwcmFkZXNofGVufDB8fDB8fHww',
    highlights: ['Dharamshala', 'Dalhousie', 'Kasauli', 'Khajjiar'],
    description: 'Snow-capped peaks, pine-scented trails and hill-station charm across the heart of the Himalayas.',
  },
  {
    id: 9,
    name: 'Goa',
    ...
    tag: 'Popular',
    category: 'Domestic',
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSpKy08fHkPTR_G2NiprW_LPKq9y5vGMtWXkOeDWrdtYsM0jrqSYgw7xi4b&s=10',
    highlights: ['Baga Beach', 'Basilica of Bom Jesus', 'Dudhsagar Falls', 'Spice Plantations'],
    description: 'Golden beaches, Portuguese heritage and vibrant nightlife — Goa is India\'s ultimate coastal getaway.',
  },
  {
    id: 10,
    name: 'Rajasthan',
    ...
    tag: 'Best Seller',
    category: 'Domestic',
    image: 'https://plus.unsplash.com/premium_photo-1661962428918-6a57ab674e23?fm=jpg&q=60&w=3000&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8cmFqYXN0aGFufGVufDB8fDB8fHww',
    highlights: ['Jaipur Forts', 'Udaipur Lakes', 'Jaisalmer Desert', 'Jodhpur Blue City'],
    description: 'Majestic forts, desert safaris and royal palaces — experience the grandeur of India\'s regal heritage.',
  },
  {
    id: 11,
    ...
    tag: 'Trending',
    category: 'Domestic',
    image: 'https://media.tacdn.com/media/attractions-splice-spp-674x446/06/96/6a/41.jpg',
    highlights: ['Gulmarg Skiing', 'Frozen Dal Lake', 'Snow Trekking', 'Gondola Ride'],
    description: 'A winter wonderland of frozen lakes, snow-laden pines and world-class skiing in Gulmarg.',
  },
  {
    id: 12,
    name: 'Madhya Pradesh',
    ...
    tag: 'Cultural',
    category: 'Domestic',
    image: 'https://plus.unsplash.com/premium_photo-1661963629241-52c812d5c7f8?fm=jpg&q=60&w=3000&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8bWFkaHlhJTIwcHJhZGVzaHxlbnwwfHwwfHx8MA%3D%3D',
    highlights: ['Khajuraho Temples', 'Bandhavgarh Safari', 'Sanchi Stupa', 'Pachmarhi'],
    description: 'Ancient temples, tiger reserves and UNESCO marvels — the cultural heartland of India awaits.',
  },
  ...
  // ── Pilgrimage Packages (6) ─────────────────────────────────────────────────
  {
    ...
    tag: 'Spiritual',
    category: 'Pilgrimage',
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTTn_7jAXRdD9eRXa2WjGOSXifAnnu7_INhVxcalxlwDEwaUZsTyhedDds&s=10',
    highlights: ['Yamunotri', 'Gangotri', 'Kedarnath', 'Badrinath'],
    description: 'The holiest yatra — four sacred shrines nestled in the Garhwal Himalayas, a once-in-a-lifetime spiritual journey.',
  },
  {
    id: 14,
    ...
    tag: 'Spiritual',
    category: 'Pilgrimage',
    image: 'https://vl-prod-static.b-cdn.net/system/images/000/740/636/af744f9ee458fa033f65cf02b9fcf7e2/original/HD-wallpaper-baba-kedarnath-kedarnath-lord-shiva.jpg',
    highlights: ['Kedarnath Temple', 'Rishikesh Ganga Aarti', 'Ram Jhula', 'Vasuki Tal'],
    description: 'Trek to the abode of Lord Shiva and feel the divine energy of Rishikesh\'s sacred ghats.',
  },
  {
    id: 15,
    name: 'Badrinath',
    ...
    description: 'Visit India\'s last village at Mana and seek blessings at the sacred Badrinath temple amid towering peaks.',
  },
  {
    id: 16,
    name: 'Kedarnath',
    ...
    tag: 'Spiritual',
    category: 'Pilgrimage',
    image: 'https://i.pinimg.com/736x/56/8f/3c/568f3c7734d7f1596b7d165600958074.jpg',
    highlights: ['Kedarnath Temple', 'Chorabari Tal', 'Gaurikund', 'Bhairav Temple'],
    description: 'A soul-stirring trek to one of the twelve Jyotirlingas, surrounded by snow peaks and pristine valleys.',
  },
  {
    id: 17,
    ...
    tag: 'Spiritual',
    category: 'Pilgrimage',
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRJQXqYQaVlzOwVWV-kAGjO1RssuCunIQQkSEvoVnQ881CWylKe1RftFyX4&s=10',
    highlights: ['Kedarnath', 'Badrinath', 'Rishikesh', 'Devprayag'],
    description: 'Combine two of India\'s most sacred Dhams in one divine yatra through the majestic Garhwal hills.',
  },
  {
    id: 18,
    name: 'Haridwar',
    ...
    tag: 'Spiritual',
    category: 'Pilgrimage',
    image: 'https://s7ap1.scene7.com/is/image/incredibleindia/ganga-ghat-haridwar1-attr-nearby?qlt=82&ts=1726645939927',
    highlights: ['Har Ki Pauri', 'Ganga Aarti', 'Mansa Devi Temple', 'Chandi Devi'],
    description: 'Witness the mesmerizing Ganga Aarti and bathe in holy waters at one of India\'s seven sacred cities.',
  },
  ...
  // ── International Packages (6) ──────────────────────────────────────────────
  {
    ...
    highlights: ['Ubud Rice Terraces', 'Tanah Lot Temple', 'Seminyak Beach', 'Kintamani Volcano'],
    description: 'Tropical temples, emerald rice paddies and sunset beaches — Bali is a paradise for every traveler.',
  },
  {
    id: 20,
    name: 'Malaysia',
    ...
    tag: 'Popular',
    category: 'International',
    image: 'https://images.pexels.com/photos/22804/pexels-photo.jpg?auto=compress&cs=tinysrgb&w=800',
    highlights: ['Petronas Towers', 'Langkawi', 'Batu Caves', 'George Town'],
    description: 'Modern skylines, ancient rainforests and multicultural street food — Malaysia is Asia\'s melting pot.',
  },
  {
    id: 21,
    name: 'Singapore',
    ...
    tag: 'Top Rated',
    category: 'International',
    image: 'https://images.pexels.com/photos/3152126/pexels-photo-3152126.jpeg?auto=compress&cs=tinysrgb&w=800',
    highlights: ['Marina Bay Sands', 'Sentosa Island', 'Gardens by the Bay', 'Universal Studios'],
    description: 'A futuristic city-state where sky-high gardens, world-class dining and multicultural buzz converge.',
  },
  {
    id: 22,
    name: 'Vietnam',
    ...
    highlights: ['Ha Long Bay', 'Hoi An', 'Ho Chi Minh City', 'Sapa Rice Terraces'],
    description: 'Emerald bays, ancient lantern-lit towns and vibrant street food — Vietnam is an unforgettable adventure.',
  },
  {
    id: 23,
    name: 'Thailand',
    ...
    highlights: ['Bangkok Temples', 'Phuket Beaches', 'Chiang Mai', 'Phi Phi Islands'],
    description: 'Golden temples, tropical islands and legendary street food — Thailand is the ultimate Southeast Asian escape.',
  },
  {
    id: 24,
    name: 'Bhutan',
    ...
    description: 'The world\'s happiest country — ancient dzongs, pristine forests and a culture that measures success in happiness.',
  },
];
...
const hotels = [
  {
    ...
    rating: 4.9,
    reviews: 324,
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS820czfa4uid0LuuDQC8umXgMntdue4oA_m4dYEVOQzNtNsbcx2lxHCJY&s=10',
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 456,
    image: 'https://pix10.agoda.net/hotelImages/4948199/0/44611f9ce1bad53b154ed11f237cf455.jpeg?ce=0&s=1024x768',
  ...
  },
  {
    ...
    rating: 4.7,
    reviews: 189,
    image: 'https://media-cdn.tripadvisor.com/media/photo-s/18/4d/63/a9/spiti-village-resort.jpg',
  ...
  },
  {
    ...
    rating: 4.9,
    reviews: 567,
    image: 'https://media.weddingz.in/photologue/images/the-grand-a-luxury-banquet-jln-marg-jaipur.jpg',
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 432,
    image: 'https://r2imghtlak.mmtcdn.com/r2-mmt-htl-image/htl-imgs/202107161117437419-e3fafef2e4a811eba1070242ac110004.jpg',
  ...
  },
  {
    ...
    rating: 4.7,
    reviews: 278,
    image: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/03/e9/bc/bd/camp-riverside-rishikesh.jpg?w=900&h=500&s=1',
  ...
  },
  {
    ...
    rating: 4.6,
    reviews: 234,
    image: 'https://media-cdn.tripadvisor.com/media/photo-s/23/5f/d3/26/woodville-palace-by-signum.jpg',
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 312,
    image: 'https://assets.cntraveller.in/photos/62da8a30e24f101ea488a135/master/w_1600%2Cc_limit/The-Dolkhar-ladakh-leh.jpg',
      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-5xl mx-auto px-4">
          ...
          <p className="text-gray-300 text-lg md:text-xl max-w-2xl mx-auto mb-10">
            24 handpicked destinations across India & the world — personalised itineraries, expert guides, memories forever.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <AnimatedSection>
            <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                { name: 'Mussoorie', img: 'https://i0.wp.com/stampedmoments.com/wp-content/uploads/2025/07/i-love-mussoorie.jpg?fit=1024%2C768&ssl=1', desc: 'Hilltop vows with panoramic Himalayan views.', venue: 'Luxury Mountain Resort' },
                { name: 'Dehradun', img: 'https://hblimg.mmtcdn.com/content/hubble/img/w2go/mmt/activities/m_webstories_places_to_visit_in_dehradun_1712_p_1200_900.jpg', desc: 'Elegant valley ceremonies in refined estates.', venue: 'Heritage Valley Estate' },
                { name: 'Rishikesh', img: 'https://media.tripinvites.com/places/rishikesh/shivpuri-750.jpg', desc: 'Riverside weddings with spiritual charm.', venue: 'Ganges Riverside Lawn' },
                { name: 'Jim Corbett', img: 'https://images.unsplash.com/photo-1665129967399-f28a228d064e?fm=jpg&q=60&w=3000&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8amltJTIwY29yYmV0dCUyMG5hdGlvbmFsJTIwcGFya3xlbnwwfHwwfHx8MA%3D%3D', desc: 'Wildlife-rich private estates for intimate celebrations.', venue: 'Private Jungle Lodge' },
                { name: 'Kasauli', img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQzkmp7oFFxXOV8AuBIS44FT6j6xmqwfZ55yQKplrw3Nn3KmY5KwW-dFBgQ&s=10', desc: 'Colonial charm and secluded hillsides.', venue: 'Colonial Heritage Villa' },
                { name: 'Chail', img: 'https://i.pinimg.com/736x/99/e9/71/99e971c6e2ca1bce2942c15a642d74ad.jpg', desc: 'Royal retreats surrounded by alpine forests.', venue: 'Royal Pine Estate' },
                { name: 'Kufri', img: 'https://t4.ftcdn.net/jpg/02/53/07/95/360_F_253079545_2gGP69Sie2uBxr6XDmUyNAMwnG94SKLK.jpg', desc: 'Snow-kissed wedding backdrops.', venue: 'Snowview Luxury Resort' },
                { name: 'Mashobra', img: 'https://s7ap1.scene7.com/is/image/incredibleindia/mashobra-shimla-himachal-pradesh-1-attr-hero?qlt=82&ts=1742167405554', desc: 'Private apple orchards and serene cottages.', venue: 'Orchard Estate' },
                { name: 'Goa', img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSw4VrtD3n2OK4-IS1uuhcbyOKRYZ0QQYIoWjbj2d4HW32GgVMJHjaCvqDW&s=10', desc: 'Beachfront celebrations with sunset vows.', venue: 'Beachfront Luxury Villas' },
                { name: 'Jaipur', img: 'https://plus.unsplash.com/premium_photo-1697729529902-276ab321f391?fm=jpg&q=60&w=3000&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8amFpcHVyJTIwY2l0eXxlbnwwfHwwfHx8MA%3D%3D', desc: 'Royal palaces and grand courtyards.', venue: 'Heritage Palace Banquet' },
                { name: 'Ranthambore', img: 'https://assets.cntraveller.in/photos/60ba1a12a1a415b43b10bcfa/master/w_1600%2Cc_limit/Arrows-Girl-Padam-Lake-Ranthambore-1620.jpg', desc: 'Dramatic fort settings and wilderness charm.', venue: 'Fortside Private Venue' },
                { name: 'Udaipur', img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSTS3SUtrBiRNs5kAmhK3nb5OxTqor_9WzVgEjPM6Ouzzwy-ORrs_5LmYdG&s=10', desc: 'Lake-palace romance and candlelit ghats.', venue: 'Lake Palace Resort' },
              ].map((d, i) => (
